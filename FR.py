...
def FR(run_in_recovery, current_theme):
    ...
    #GUI элементы
    tk.Label(FR_GUI, text=f"1){l["what_to_replace"]}:", bg=current_theme["lbg"], fg=current_theme["lfg"], font=("Default", 9, "bold")).pack(anchor="w", padx=10, pady=(10, 0))
    ...
    tk.Button(src_frame, text=l["review"], bg=current_theme["bbg"], fg=current_theme["bfg"], activebackground=current_theme["abg"], activeforeground=current_theme["afg"], command=lambda: browse_source(source_path)).pack(side="right", padx=5)

    tk.Label(FR_GUI, text=f"2){l["what_are_replace"]}:", bg=current_theme["lbg"], fg=current_theme["lfg"]).pack(anchor="w", padx=10, pady=(10, 0))
    ...
    tk.Button(tgt_frame, text=l["review"], bg=current_theme["bbg"], fg=current_theme["bfg"], activebackground=current_theme["abg"], activeforeground=current_theme["afg"], command=lambda: browse_target(target_path)).pack(side="right", padx=5)
    ...
    tk.Button(btn_frame, text=l["replace"],
              ...
              bg="red", width=15, font=("Default", 9, "bold")).pack(side="left", padx=10)
